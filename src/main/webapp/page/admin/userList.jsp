...
<div id="tb">
    ...
    <div>
        <a  id="openAddDialog"  class="easyui-linkbutton"
           iconCls="icon-add" plain="true">添加</a> <a
            id="openModifyDialog" class="easyui-linkbutton"
            iconCls="icon-edit" plain="true">修改</a> <a
            id="openRestePwDialog" class="easyui-linkbutton"
            iconCls="icon-edit" plain="true">密码重置</a>
    </div>
