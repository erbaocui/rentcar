...
<div id="tb">
    <div>
        <tabel>
            ...
            <tr>
                <td>车&nbsp;&nbsp;牌：<input type="text" id="qryPlateNumber" size="20"/><td>
                <td>&nbsp;状态：&nbsp;
...
<div id="dlg" class="easyui-dialog"
    ...
    <form id="fm" method="post">
        ...
        <table cellspacing="8px">
            <tr>
                <td>车&nbsp;&nbsp;&nbsp;牌：</td>
                <td><input type="text" id="plateNumber"  name="plateNumber"
                           class="easyui-validatebox" data-options="required:true,validType:['CheckCar']"/>&nbsp;
                </td>
            </tr>
            <tr>
                <td>车&nbsp;&nbsp;&nbsp;型：</td>

                <td>  <input class="easyui-combobox shopVipInfoInput" name="typeId"  panelHeight="auto" id="typeId" editable="true"/>&nbsp;
                </td>
            </tr>
