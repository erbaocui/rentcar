...
<head>
    ...
    <script type="text/javascript" src="rvList.js"></script>
...
<div id="tb">
    <div>
        <tabel>
            ...
            <tr>
                <td>&nbsp;房车图片名称：&nbsp;<input type="text" id="qryPicName" name="qryPicName" size="20"/><td>
                <input type="hidden" id="qryPicType" name="qryPicType" value="5" />
                <td>&nbsp;状态：&nbsp;
